...
<div class="col-md-12" id="new_post2">
    ...
    <h4 class="user_dashboard_panel_title"><?php  esc_html_e('General','wpestate');?></h4>
    ...
    <div class="col-md-8"> 
        <label for="property_description"><?php esc_html_e('Equipment Description','wpestate');?></label>

...
<div class="adv-search-2 <?php echo $google_map_lower_class.' '.$close_class.' '.$extended_class;?>" id="adv-search-1" data-postid="<?php echo $post_id; ?>"> 
    ...
    <form  method="get"  id="main_search" action="<?php print $adv_submit; ?>" >
        ...
        <div class="col-md-12 map_icon">       
            ...
            ?>
            <input type="text"    id="search_location<?php echo $wpestate_internal_search;?>"      class="form-control" name="search_location" placeholder="<?php esc_html_e('Search Equipment','wpestate');?>" value="" >              
        </div>
		<div class="col-md-12 has_calendar calendar_icon">
            <div class="dropdown form-control">
                ...
                <ul  class="dropdown-menu filter_menu"  id="category_main_list" role="menu" aria-labelledby="category">

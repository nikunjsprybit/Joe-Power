...
<div class="social_share_wrapper">
	...
	<?php if ($instagram_link!='' ){?>
        <a class="social_share share_google_side" href="<?php echo $instagram_link;?>" target="_blank"><i class="fa fa-instagram"></i></a>
    <?php }else{
		?>
         <!-- <a class="social_share share_google_side" href="//www.instagram.com/_joepower/" target="_blank"><i class="fa fa-instagram"></i></a> -->
    <?php
	} ?>

    <?php if ($reddit_link!='' ){?>
        <a class="social_share share_google_side" href="<?php echo $reddit_link;?>" target="_blank"><i class="fa fa-reddit"></i></a>
    <?php } ?>

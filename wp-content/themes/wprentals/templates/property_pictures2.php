 <?php
    ...
    print '<div class="panel-title panel_pictures">'.esc_html__( 'Equipment Pictures','wpestate').'<span class="pictures_explanation">  '. $total_pictures .' '.esc_html__( 'photos','wpestate').'</span></div>';

...
$hobbies                =   get_user_meta($userID, 'hobbies', true);
...
$payment_info           =   get_the_author_meta( 'payment_info' , $userID );
        //esc_html(get_post_meta($post->ID, 'payment_info', true))
        ...
        <div class=" row">  
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-8">
                    ...
                    <p>
                        <label for="about_me"><?php esc_html_e('My Trade / Industry is','wpestate');?></label>
                        <textarea id="about_me" class="form-control about_me_profile" name="about_me"><?php echo $about_me;?></textarea>
                    </p>

                    <p>
                        <label for="hobbies"><?php esc_html_e('My Hobbies are','wpestate');?></label>
                        <textarea id="hobbies" class="form-control about_me_profile" name="hobbies"><?php echo $hobbies;?></textarea>
                    </p>

...
<?php 
if( is_front_page() ){ $col_class = $col_class; } 
else if ( is_page_template('property_list.php') ) { $col_class = 'col-md-4'; } 
else if ( is_page('advanced-search') ) { $col_class = 'col-md-6'; } 
...
<div class="listing_wrapper <?php echo $col_class.' '.$listing_type_class; ?> ssx property_flex " data-org="<?php echo $col_org;?>" data-listid="<?php echo $post->ID;?>" > 
    <div class="property_listing " data-link="<?php echo $link;?>">
        <?php
            ...
            $property_categ     =   get_the_term_list($post->ID, 'product_cat', '', ', ', ''); 
            ?>
            ...
            <div class="title-container">
                ...
                $preview_agent_img    =   get_the_author_meta( 'custom_picture' , $post_author );
                if($user_custom_picture==''){
                    $user_custom_picture    =   get_template_directory_uri().'/img/default_user_agent.gif';
                } ?>
                ...
                <div class="category_name">
                    <a href="<?php echo $link;?>" class="listing_title_unit">
                        ...
                        <div class="category_tagline">
                            ...
                            <?php if(!empty($property_city) || !empty($property_area)){ ?>
                               
                                <?php  
                                $address = $property_area;
                                if(!empty($property_city) && !empty($property_area)){
                                    $address .= ', ';
                                } 
                                $address .= $property_city; 

                                echo mb_substr ( html_entity_decode ($address), 0, 26, "UTF8") ; 
                                if(strlen($address)>26){
                                    echo '...';   
                                }
                                ?>
                            <?php } else { echo "Not Define."; } ?>
                        </div>
                    
                        <div class="category_tagline">
                            <?php if(!empty($property_categ)){ ?>
                ...
                <div class="property_unit_action">
                    <span class="icon-fav <?php echo $favorite_class; ?>" data-original-title="<?php echo $fav_mes; ?>" data-postid="<?php echo $post->ID; ?>"><i class="fa fa-star"></i></span>
                </div>
            </div>
        <?php 

            ...
            <div class="title-container">
                ...
                <div class="category_tagline_wrapper">
                    <div class="category_tagline">
                        ...
                        <?php  
                        $property_area = (get_post_meta($post->ID, 'property_address', true)) ? get_post_meta($post->ID, 'property_address', true).' ' : '';
                        $property_city = (get_post_meta($post->ID, 'property_county', true)) ? get_post_meta($post->ID, 'property_county', true).' ' : '';

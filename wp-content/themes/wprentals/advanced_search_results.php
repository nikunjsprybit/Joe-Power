...
if( isset($_GET['category'])){
    $category        =  sanitize_text_field( wp_kses ($_GET['category'],$allowed_html));
}
...
//////////////////////////////////////////////////////////////////////////////////////
    ...
    /// map pins
    ///////////////////////////////////////////////////////////////////////////////////////////////////
    if ( is_page_template('advanced_search_results.php')   && $book_from!='' && $book_to!='' ){  
        //check reservation
...
<script type="text/javascript">
    jQuery(document).ready( function() {
        var category = jQuery('#category').data('value');
        jQuery('#category_main').val(category);
        jQuery('#search_location').val("<?php echo $_GET['search_location'];?>");
    });
</script>
<?php get_footer(); ?>
    ...
    <div class="row is_dashboard">
        ...
        <div class=" dashboard-margin">
            ...
            <div class="search_dashborad_header">
                ...
                <div class="col-md-4">
                    <input type="text" id="title" class="form-control" value="<?php echo $title_search; ?>" size="20" name="wpestate_prop_title" placeholder="<?php esc_html_e('Search by Equipment Name.','wpestate');?>">
                </div>
                <div class="col-md-6">

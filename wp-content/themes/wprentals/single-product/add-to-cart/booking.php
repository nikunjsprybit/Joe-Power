...
<form class="cart custom_cart" method="post" enctype='multipart/form-data'>
	...
	<button type="submit" class="wc-bookings-booking-form-button single_add_to_cart_button button wpestate_vc_button wpb_btn-info wpb_btn-small alt " disabled="disabled">Book Now<?php //echo $product->single_add_to_cart_text(); ?></button>

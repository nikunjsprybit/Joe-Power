...
if( isset( $_GET['listing_edit'] ) && is_numeric( $_GET['listing_edit'] ) ){
    ...
    $submit_General             =   get_post_field('post_content', $edit_id);
    
    $action_array=array("General","Image","Categories","Inventory","Shipping","Attributes","Availability/Pricing");
        ...
        <?php while (have_posts()) : the_post(); ?>
            ...
            <?php
                ...
                if ($action == 'General'){
                    ...
                    get_template_part('templates/submit_templates/property_General');                    
                }else if ($action =='location'){

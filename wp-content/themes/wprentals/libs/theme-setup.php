...
function wp_estate_setup() {  
    ...
    if ( is_admin() && isset($_GET['activated'] ) && $pagenow == "themes.php" ) {
        ...
        add_option('wp_estate_property_features_text', 'Equipment Features');
        add_option('wp_estate_property_description_text', 'Equipment Description');
        add_option('wp_estate_property_details_text',  'Equipment Details ');

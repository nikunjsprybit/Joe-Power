...
function  wpestate_theme_slider(){
    ...
    print'<div class="estate_option_row">
        <div class="label_option_row">'.__('Select Equipments ','wpestate').'</div>
        <div class="option_row_explain">'.__('Select equipments for slider - *hold CTRL for multiple select ','wpestate').'</div>'; 

...
if( !function_exists('estate_listing_address') ):
    function estate_listing_address($post_id){
        ...
        if ($property_county != ''){
            $return_string.= '<div class="listing_detail list_detail_prop_county col-md-6"><span class="item_head">'.esc_html__( 'City','wpestate').':</span> ' . $property_county . '</div>'; 
        }
        if ($property_state != ''){
...
if( !function_exists('estate_listing_address_print') ):
    function estate_listing_address_print($post_id){
        ...
        $property_address   = esc_html( get_post_meta($post_id, 'property_address', true) );
        $property_city      = esc_html( get_post_meta($post_id, 'property_city', true)) ;
...
if( !function_exists('estate_listing_details') ):
    function estate_listing_details($post_id){
        ...
        if ($property_status != '' && $property_status != 'normal' ){
            $return_string.= '<div class="listing_detail list_detail_prop_status col-md-6"><span class="item_head">'.esc_html__( 'Equipment Status','wpestate').':</span> ' . $property_status . '</div>';
        }   
        
        $return_string.= '<div class="listing_detail list_detail_prop_id col-md-6"><span class="item_head">'.esc_html__( 'Equipment ID','wpestate').':</span> ' . $post_id . '</div>';
      
        
        if ($property_size != ''){
            $return_string.= '<div class="listing_detail list_detail_prop_size col-md-6"><span class="item_head">'.esc_html__( 'Equipment Size','wpestate').':</span> ' . $property_size . '</div>';
        }               
        if ($property_lot_size != ''){
            $return_string.= '<div class="listing_detail list_detail_prop_lot_size  col-md-6"><span class="item_head">'.esc_html__( 'Equipment Lot Size','wpestate').':</span> ' . $property_lot_size . '</div>';
        }      
        if ($property_rooms != ''){

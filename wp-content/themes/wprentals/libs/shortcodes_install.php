...
if (function_exists('vc_map')):
    ...
    vc_map(
            array(
                "name" => esc_html__("Featured Equipment", "wpestate"),
                ...
                'weight' => 100,
                'icon' => 'wpestate_vc_logo',
                'description' => esc_html__('Featured Equipment Shortcode', 'wpestate'),
                "params" => array(
                    array(
                        "type" => "textfield",
                        "holder" => "div",
                        "class" => "",
                        "heading" => esc_html__("Equipment id", "wpestate"),
                        "param_name" => "id",
                        "value" => "",
                        "description" => esc_html__("Equipment id", "wpestate")
                    ),
                    array(
                        "type" => "textfield",
                        "holder" => "div",

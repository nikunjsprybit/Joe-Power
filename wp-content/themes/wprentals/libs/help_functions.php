        ...
        if( $tip=='global' ){
            ...
            switch ($header_type) {
                ...
                case 5://google maps
                    ...
                    break;
				case 6://header video
                    get_template_part('templates/header_video'); 
                    break;
              }  
        }
...
///////////////////////////////////////////////////////////////////////////////////////////
// dashboard shop front page
///////////////////////////////////////////////////////////////////////////////////////////


if( !function_exists('wpestate_shop_link') ):
    function wpestate_shop_link(){

         $pages = get_pages(array(
                'meta_key' => '_wp_page_template',
                'meta_value' => 'user_dashboard_shop.php'
                    ));
        if( $pages ){
            $dash_shop = esc_url (get_permalink( $pages[0]->ID) );
        }else{
            $dash_shop=esc_html( home_url() );
        }    
        return $dash_shop;
    }
endif;
...
if( !function_exists('wpestate_billing_link') ):
    function wpestate_billing_link(){

         $pages = get_pages(array(
                'meta_key' => '_wp_page_template',
                'meta_value' => 'user_dashboard_billing.php'
                    ));
        if( $pages ){
            $dash_billing = esc_url (get_permalink( $pages[0]->ID) );
        }else{
            $dash_billing=esc_html( home_url() );
        }    
        return $dash_billing;
    }
endif;
...
if( !function_exists('wpestate_withdrawal_link') ):
    function wpestate_withdrawal_link(){

         $pages = get_pages(array(
                'meta_key' => '_wp_page_template',
                'meta_value' => 'user_dashboard_withdrawal.php'
                    ));
        if( $pages ){
            $dash_withdrawal = esc_url (get_permalink( $pages[0]->ID) );
        }else{
            $dash_withdrawal=esc_html( home_url() );
        }    
        return $dash_withdrawal;
    }
endif;
...
if( !function_exists('wpestate_history_link') ):
    function wpestate_history_link(){

         $pages = get_pages(array(
                'meta_key' => '_wp_page_template',
                'meta_value' => 'user_dashboard_history.php'
                    ));
        if( $pages ){
            $dash_history = esc_url (get_permalink( $pages[0]->ID) );
        }else{
            $dash_history=esc_html( home_url() );
        }    
        return $dash_history;
    }
endif;
...
if( !function_exists('wpestate_get_dashboard_profile_link') ):
    function wpestate_get_dashboard_profile_link($type=null){
		if(is_user_logged_in() || $type!=null){
			$pages = get_pages(array(
                'meta_key' => '_wp_page_template',

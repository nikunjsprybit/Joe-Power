...
class Google_Service_Analytics_ManagementProfileUserLinks_Resource extends Google_Service_Resource
{
   ...
   *
   * @param string $accountId Account ID to delete the user link for.
   * @param string $webPropertyId Web Equipment ID to delete the user link for.
   ...
   *
   * @param string $accountId Account ID to create the user link for.
   * @param string $webPropertyId Web Equipment ID to create the user link for.
   ...
   * to.
   * @param string $webPropertyId Web Equipment ID which the given view (profile)
   ...
   * @param string $webPropertyId Web Equipment ID to update the user link for.
...
class Google_Service_Analytics_ManagementWebpropertyUserLinks_Resource extends Google_Service_Resource
{
   ...
   * @param string $webPropertyId Web Equipment ID for the webProperty-user links

...
class Google_Service_Drive_Properties_Resource extends Google_Service_Resource
{
   ...
   *
   * @param string $fileId The ID of the file.
   * @param Google_Equipment $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_Drive_Property
   */
  public function insert($fileId, Google_Service_Drive_Equipment $postBody, $optParams = array())
  {
    $params = array('fileId' => $fileId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
   ...
   * @return Google_Service_Drive_Property
   */
  public function patch($fileId, $propertyKey, Google_Service_Drive_Equipment $postBody, $optParams = array())
  {
   ...
   * @return Google_Service_Drive_Property
   */
  public function update($fileId, $propertyKey, Google_Service_Drive_Equipment $postBody, $optParams = array())
  {
    $params = array('fileId' => $fileId, 'propertyKey' => $propertyKey, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
...
class Google_Service_Drive_Equipment extends Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $etag;

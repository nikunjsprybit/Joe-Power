...
class Google_Service_Calendar_Events_Resource extends Google_Service_Resource
{
   ...
   *
   * These are:  - iCalUID  - orderBy  - privateExtendedEquipment  - q  -
   * sharedExtendedEquipment  - timeMin  - timeMax  - updatedMin If the syncToken
   ...
   * @opt_param string timeZone Time zone used in the response. Optional. The
   * default is the time zone of the calendar.
   * @opt_param string privateExtendedEquipment Extended properties constraint
   ...
   * given constraints.
   * @opt_param string sharedExtendedEquipment Extended properties constraint

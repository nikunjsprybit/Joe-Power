...
function wpestate_create_property_type() {
    /* register_post_type('estate_property', array(
        'labels' => array(
            'name'                  => esc_html__( 'Equipments','wpestate'),
            'singular_name'         => esc_html__( 'Equipment','wpestate'),
            'add_new'               => esc_html__( 'Add New Equipment','wpestate'),
            'add_new_item'          => esc_html__( 'Add Equipment','wpestate'),
            'edit'                  => esc_html__( 'Edit','wpestate'),
            'edit_item'             => esc_html__( 'Edit Equipment','wpestate'),
            'new_item'              => esc_html__( 'New Equipment','wpestate'),
            'view'                  => esc_html__( 'View','wpestate'),
            'view_item'             => esc_html__( 'View Equipment','wpestate'),
            'search_items'          => esc_html__( 'Search Equipment','wpestate'),
            'not_found'             => esc_html__( 'No Equipments found','wpestate'),
            'not_found_in_trash'    => esc_html__( 'No Equipments found in Trash','wpestate'),
            'parent'                => esc_html__( 'Parent Equipment','wpestate')
        ),
        'public' => true,
        'has_archive' => true,
...
////////////////////////////////////////////////////////////////////////////////////////////////
    /* register_taxonomy('property_category', 'estate_property', array(
        'labels' => array(
            ...
            'add_new_item'      => esc_html__( 'Add New Equipment Category','wpestate'),
            'new_item_name'     => esc_html__( 'New Equipment Category','wpestate')
        ),
        'hierarchical'  => true,
        'query_var'     => true,
...
}// end create Equipment type
endif; // end   wpestate_create_property_type      



///////////////////////////////////////////////////////////////////////////////////////////////////////////
///  Add metaboxes for Equipment
///////////////////////////////////////////////////////////////////////////////////////////////////////////
if( !function_exists('wpestate_add_property_metaboxes') ):
function wpestate_add_property_metaboxes() {
    add_meta_box('estate_property-sectionid',       esc_html__( 'Equipment Settings', 'wpestate'),      'estate_box', 'estate_property', 'normal', 'default');
    add_meta_box('estate_property-propdetails',     esc_html__( 'Equipment Details', 'wpestate'),       'details_estate_box', 'estate_property', 'normal', 'default');
    add_meta_box('estate_property-custom',          esc_html__( 'Equipment Custom', 'wpestate'),        'wpestate_custom_details_box', 'estate_property', 'normal', 'default');
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
///  Equipment Custom details  function
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
///  Equipment Pay Submission  function
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
function map_estate_box($post) {
    ...
    <p class="meta-options"> 
        <a class="button" href="#" id="admin_place_pin">'.esc_html__( 'Place Pin with Equipment Address','wpestate').'</a>
    </p>
...
function agentestate_box($post) {
    ...
    print '
    <label for="property_zip">'.esc_html__( 'Equipment Owner: ','wpestate').'</label><br />
...
function estate_box($post) {
    ...
    <td align="left" valign="top">
        <p class="meta-options">
           <label for="property_status">'.esc_html__( 'Equipment Status:','wpestate').'</label><br />
      ...
      <td align="left" valign="top">  
           <p class="meta-options"> 
              ...
              print' />
              <label for="prop_featured">'.esc_html__( 'Make it Featured Equipment','wpestate').'</label>
          </p>
     </td>

            ...
            ';
                ...
                $logged_display='
                    ...
                    if($home_url!=$dash_link && wpestate_check_user_level()){
                        $logged_display.=' <li> <a href="'.$dash_link.'"     class="'.$activedash.'"><i class="fa fa-map-marker"></i>'.esc_html__( 'My Equipment','wpestate').'</a> </li>';
                    }
                    if($home_url!=$add_link && wpestate_check_user_level()){
                        $logged_display.=' <li> <a href="'.$add_link.'"      class="'.$activeadd.'"><i class="fa fa-plus"></i>'. esc_html__( 'Add New Equipment','wpestate').'</a> </li>';
                    }

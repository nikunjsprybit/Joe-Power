...
Vendor frontend shop/store manager for WC Vendors, WC Marketplace and WC Product Vendors - multivendor marketplace plugins. WooCommerce Bookings && WooCommerce Subscriptions integrated. Frontend Product Manager, Orders, Coupons and Reports manage from your live site.

== Description ==
Managing online store is always a pain and headache! WCFM works as vendor frontend shop/store manager - Product Manager, Coupon Manager, Orders and view Reports from your live site frontend, no more wp-admin backend. Fully compatible with multi-vendor marketplace plugins - <strong>WC Marketplace</strong>, <strong>WC Vendors</strong> and <strong>WooCommerce Product Vendors</strong>. Now also integrated with <strong>WooCommerce Bookings</strong>, <strong>WooCommerce Subscriptions</strong> and <strong>WP Job Manager</strong>.

> First check by yourself and then move on -
> [WCFM Demo](http://demo.wclovers.com/my-account/)
>
> Add more frontend power - 
> [WCFM Ultimate](http://wclovers.com/product/woocommerce-frontend-manager-ultimate/) - [Overview](https://www.youtube.com/channel/UCJ0c60fv3l1K9mBbHdmR-5Q) - [Documentation](http://wclovers.com/documentation/)
...
Fully compatible with WP-WC most popular multivendor marketplace addons - 

- <strong>WC Marketplace</strong> - [Overview](https://www.youtube.com/watch?v=8EV75_1d9C4) - [Documentation](http://wclovers.com/documentation/wcfm-wc-marketplace/) - [Demo](http://wcmp.wclovers.com/my-account/)
- <strong>WC Vendors</strong> - [Overview](https://www.youtube.com/watch?v=wOTY5gfxwug) - [Documentation](http://wclovers.com/documentation/wcfm-wc-vendors/) - [Demo](http://wcvendors.wclovers.com/my-account/)
- <strong>WooCommerce Product Vendors</strong> - [Overview](https://www.youtube.com/watch?v=cdRXsJcu3xc) - [Documentation](http://wclovers.com/documentation/wcfm-wc-product-vendors/) - [Demo](http://wcpvendors.wclovers.com/my-account/)

= Booking Compatibility =

Exclusively integrated with <strong>WooCommerce Bookings</strong> -

- <strong>WC Bookings</strong> - [Overview](https://www.youtube.com/watch?v=M0orUa8deyU) - [Documentation](http://wclovers.com/documentation/wcfm-wc-booking/) - [Demo](http://wcbooking.wclovers.com/my-account/)

[youtube https://www.youtube.com/watch?v=KKyKsUULgpw]

= Quick view - what will be on your plate? =

- Create and Manage Simple, Variable, Grouped, External, Subscription and Bookable Products
...
WCFM is fully compatible with any WP-WC themes. We also provide WCFM dashboard color option to make it more look alike your site appearnce. Now we are added exclusive support with the most popular WooCommerce themes. [Check here](http://wclovers.com/wcfm-exclusive-theme-support/).

= Exclusive Plugin Support =

WCFM is now fully integrated with -
...
Feel free to reach us either via our [support forum](http://wclovers.com/forums) or [WordPress.org](https://wordpress.org/support/plugin/wc-frontend-manager), happy to serve anything you looking for. 

Really proud to serve and enhance [WooCommerce](http://woocommerce.com).

Be with us ... Team [WC Lovers](http://wclovers.com)
...
For quick reference refer to our [user guide](http://wclovers.com/documentation)
...
For help with WCFM Ultimate from wclovers.com, use [our helpdesk](http://wclovers.com/forums).
...
We are working hard to add support of all major WC-extensions. If you are looking for anything right now then feel free to contact us at ‘wclovers.contact@gmail.com' or [our helpdesk](http://wclovers.com/forums)

= Does it work with Marketplace-Vendor plugins? =

Fully compatible with multivendor marketplace <strong>WC Marketplace</storng> and <strong>WC Vendors</storng>.

== Screenshots ==

1. WCFM Dashboard
2. WCFM Product Manager
3. WCFM Diverse of Reports
4. WCFM Order Details
5. WCFM Products Dashboard
6. WooCommerce Shop
7. WCFM Quick Product Manager
8. WCFM Orders Dashboard
9. WCFM Coupon Manager
10. WCFM Bookings Dashboard
11. WCFM Booking Product Manager
12. WCFM Booking Details
13. WCFM Settings Panel

== Changelog ==

= 2.2.3 = 
* Feature - WP Job Manager integrated

= 2.2.2 =
* Feature - WooCommerce Subscription integrated
* Feature - WooCommerce MSRP Pricing integrated

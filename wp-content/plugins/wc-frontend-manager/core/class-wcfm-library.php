  ...
  public $views_path;
	...
	public function load_scripts( $end_point ) {
      ...
      break;
        ...
        wp_enqueue_script( 'wcfm_products_js', $this->js_lib_url . 'wcfm-script-products.js', array('jquery'), $WCFM->version, true );
      break;
      ...
      case 'wcfm-products-manage':
        ...
        wp_enqueue_script( 'wcfm_products_manage_js', $this->js_lib_url . 'wcfm-script-products-manage.js', array('jquery'), $WCFM->version, true );
      ...
      case 'wcfm-coupons':
        $this->load_datatable_lib();
        wp_enqueue_script( 'wcfm_coupons_js', $this->js_lib_url . 'wcfm-script-coupons.js', array('jquery'), $WCFM->version, true );
      break;
      ...
      case 'wcfm-orders':
        $this->load_datatable_lib();
        wp_enqueue_script( 'wcfm_orders_js', $this->js_lib_url . 'wcfm-script-orders.js', array('jquery'), $WCFM->version, true );
      break;
      ...
      case 'wcfm-reports-out-of-stock':
      	$this->load_datatable_lib();
        wp_enqueue_script( 'wcfm_reports_js', $this->js_lib_url . 'wcfm-script-reports-out-of-stock.js', array('jquery'), $WCFM->version, true );
      break;
	...
	*/
	...
	function load_datatable_lib() {
		...
		// JS
		wp_enqueue_script( 'dataTables_js', '//cdn.datatables.net/1.10.12/js/jquery.dataTables.min.js', array('jquery'), $WCFM->version, true );
		wp_enqueue_script( 'dataTables_responsive_js', '//cdn.datatables.net/responsive/2.1.0/js/dataTables.responsive.min.js', array('jquery', 'dataTables_js'), $WCFM->version, true );
		
		// CSS
		wp_enqueue_style( 'dataTables_css',  '//cdn.datatables.net/1.10.12/css/jquery.dataTables.min.css', array(), $WCFM->version );
		wp_enqueue_style( 'dataTables_responsive_css',  '//cdn.datatables.net/responsive/2.1.0/css/responsive.dataTables.min.css', array(), $WCFM->version );
	}
	...
	*/
	public function load_qtip_lib() {
	  global $WCFM;
	  wp_enqueue_script( 'qtip_js', $WCFM->plugin_url . 'includes/libs/qtip/qtip.js', array('jquery'), $WCFM->version, true );
		wp_enqueue_style( 'qtip_css',  $WCFM->plugin_url . 'includes/libs/qtip/qtip.css', array(), $WCFM->version );
	}

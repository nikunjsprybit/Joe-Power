							...
							<li class="sales-count-this-month">
							  <span class="fa fa-shopping-cart"></span>
								<a href="<?php echo get_wcfm_reports_url( ); ?>">
									<?php printf( __( '<strong>%s</strong><br /> net sales in this month', $WCFM->text_domain ),wc_price( $total_product_amount ) ); ?>
								</a>
							</li>
							<li class="sales-this-month">
							  <span class="fa fa-money"></span>
								<a href="<?php echo get_wcfm_reports_url( ); ?>">
									<?php printf( __( '<strong>%s</strong><br /> commission this month', $WCFM->text_domain ), wc_price( $commission ) ); ?>
								</a>
							</li>
							<?php } ?>
							<li class="sales-count-this-month">
							...
							<li class="best-seller-this-month">
							  <span class="fa fa-cube"></span>
								<a href="<?php echo apply_filters( 'sales_by_product_report_url',  get_wcfm_reports_url( ), $top_seller_id ); ?>">
									<?php printf( __( "%s top seller this month (sold %d)", $WCFM->text_domain ), "<strong>" . $top_seller_title . "</strong><br />", $top_seller_qty ); ?>
								</a>
							</li>

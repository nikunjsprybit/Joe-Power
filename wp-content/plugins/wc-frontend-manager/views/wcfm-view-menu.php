...
$style = 'style="display:none; list-style-type: none;"';
...
if ( basename( get_page_template() ) == 'user_dashboard.php'  || is_page('my-equipment') ){
    ...
    $style = 'style="display:block; list-style-type: none;"';
...
<div class="user_tab_menu col-md-3" id="user_tab_menu_container">
    ...
    <div class="custom_user_dashboard user_dashboard_links user_dashboard_links_wcfm">
        ...
        <?php if( $allow == 'allow' ){ ?>
            ...
            <ul class="submenu" data-parent="vendor-report" <?php echo $style; ?>>
                ...
                <li class="wcmp-venrod-dashboard-nav-link wcmp-venrod-dashboard-nav-link--wcfm-reports-sales-by-date <?php echo $dateActiveClass; ?>">
        ...
        <?php if( $dash_inbox!=$home_url ){ ?>
                ...
                <ul class="submenu" data-parent="vendor-payments" style="display:none; list-style-type: none;">
                    <li class="wcmp-venrod-dashboard-nav-link wcmp-venrod-dashboard-nav-link--transaction-details ">
                        <a href="<?php echo $home_url.'/wcmp/vendor-orders/';?>" class="">- Orders List</a>
                    </li>
                    <li class="wcmp-venrod-dashboard-nav-link wcmp-venrod-dashboard-nav-link--transaction-details">
                        <a href="<?php echo $home_url; ?>/wcmp/transaction-details/" target="_self">- Payments History</a>
                    </li>
                </ul>
        <?php } ?>
...
<script type="text/javascript">
    jQuery(document).ready( function(){
        console.log(121111111113);
        jQuery('.user_dashboard_links_wcfm').on('click', '.hasmenu', function(){

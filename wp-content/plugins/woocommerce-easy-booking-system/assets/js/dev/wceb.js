...
(function($) {
	...
	$(document).ready( function() {
		...
		// Fix to force http/https when calling admin-ajax.php file
		admin_ajax_url = ( location.protocol === 'https:' ? 'https:' : 'http:' ) + wceb_object.ajax_url;
			...
			$selector.each( function() {
				...
				$(this).find( '.addon' ).each( function() {
					...
					if ( typeof id !== 'undefined' ) {
						...
						var product_id   = $('input[name=add-to-cart], button[name=add-to-cart]').val();

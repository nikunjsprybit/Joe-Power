    ...
    public function wcmp_create_vendor_dashboard_navigation($args = array()) {
        ...
        $vendor_nav = array(
            'dashboard' => array(
                ...
                , 'submenu' => array()
                , 'link_target' => '_self'
                , 'nav_icon' => 'fa fa-tachometer'
            ),
            'my-profile' => array(
                'label' => __('My Profile', $WCMp->text_domain)
                , 'url' => $dash_profile
                , 'capability' => apply_filters('wcmp_vendor_dashboard_menu_dashboard_capability', true)
                , 'position' => 1
                , 'submenu' => array()
            ...
            'my-equipments' => array(
                'label' => __('My Equipments', $WCMp->text_domain)
                , 'url' => $dash_link
                , 'capability' => apply_filters('wcmp_vendor_dashboard_menu_dashboard_capability', true)
                , 'position' => 2
                , 'submenu' => array()
                , 'link_target' => '_self'
                , 'nav_icon' => 'fa fa-map-marker'
            ),
            'add-new-equipment' => array(
                'label' => __('Add New Equipment', $WCMp->text_domain)
                , 'url' => $add_link
                , 'capability' => apply_filters('wcmp_vendor_dashboard_menu_dashboard_capability', true)
                , 'position' => 3
                , 'submenu' => array()
                , 'link_target' => '_self'
                , 'nav_icon' => 'fa fa-plus-circle'
            ),
            'all-in-one-calendar' => array(
                'label' => __('All In One Calendar', $WCMp->text_domain)
                , 'url' => $dash_allinone
                , 'capability' => apply_filters('wcmp_vendor_dashboard_menu_dashboard_capability', true)
                , 'position' => 4
                , 'submenu' => array()
            ...
            /*'vendor-products' => array(
                'label' => __('Equipment Manager', $WCMp->text_domain)
            ...
            'vendor-payments' => array(
                ...
                , 'submenu' => array(
                    'vendor-orders' => array(
                        'label' => __('Orders List', $WCMp->text_domain)
                        , 'url' => wcmp_get_vendor_dashboard_endpoint_url(get_wcmp_vendor_settings('wcmp_vendor_orders_endpoint', 'vendor', 'general', 'vendor-orders'))
                        , 'capability' => apply_filters('wcmp_vendor_dashboard_menu_vendor_orders_capability', true)
                        , 'position' => 10
                        , 'link_target' => '_self'
                    ...
                    'transaction-details' => array(
                        'label' => __('Payment History', $WCMp->text_domain)
            ...
            'invoices' => array(
                'label' => __('Invoices', $WCMp->text_domain)
                , 'url' => $dash_invoice
                , 'capability' => apply_filters('wcmp_vendor_dashboard_menu_dashboard_capability', true)
                , 'position' => 51
                , 'submenu' => array()
                , 'link_target' => '_self'
                , 'nav_icon' => 'fa fa-file-o'
            ),
            /*'vendor-payments' => array(

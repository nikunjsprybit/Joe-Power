...
class WCMp_Product {
    ...
    function add_report_abuse_link() {
        ...
        if($is_display) {
            ?>
            <a href="javascript:void(0);" id="report_abuse" data-toggle="modal" data-target="#reportmodel"><?php echo $display_text; ?></a><br>
            <div class="modal  fade in" id="reportmodel" tabindex="-1" aria-labelledby="reprotproductLabel" aria-hidden="false"> 
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                <h2 class="modal-title_big"><?php _e('Report an abuse for product ', 'dc-woocommerce-multi-vendor') . ' ' . the_title(); ?></h2>
                                <h4 class="modal-title" id="reprotproductLabel">Please complete the form below to report the project.</h4>
						</div>
						<div class="modal-body">
							<div class="row">
								<div class="col-sm-12">
									<form method="post" id="report-abuse" class="report-abuse-form" name="report-abuse">
										<table width="100%">
											<tbody>
												<tr>
													<td>
														<input type="text" class="report_abuse_name form-control" id="report_abuse_name" name="report_abuse[name]" value="" style="width: 100%;" placeholder="<?php _e('Name', 'dc-woocommerce-multi-vendor'); ?>" required="">
														<span class="wcmp-report-abuse-error"></span>
													</td>
												</tr>
												<tr>
													<td>
														<input type="email" class="report_abuse_email form-control" id="report_abuse_email" name="report_abuse[email]" value="" style="width: 100%;" placeholder="<?php _e('Email', 'dc-woocommerce-multi-vendor'); ?>" required="">
														<span class="wcmp-report-abuse-error"></span>
													</td>
												</tr>
												<tr>
													<td>
														<textarea name="report_abuse[message]" class="report_abuse_msg form-control" id="report_abuse_msg" rows="5" style="width: 100%;" placeholder="<?php _e('Leave a message explaining the reasons for your abuse report', 'dc-woocommerce-multi-vendor'); ?>" required=""></textarea>
														<span class="wcmp-report-abuse-error"></span>
													</td>
												</tr>
												<tr>
													<td>
														...
														<input type="submit" class="wpb_button wpb_btn-info wpb_regularsize wpestate_vc_button vc_button" name="report_abuse[submit]" value="<?php _e('Report', 'dc-woocommerce-multi-vendor'); ?>">
													</td>
												</tr>
											</tbody>
										</table>

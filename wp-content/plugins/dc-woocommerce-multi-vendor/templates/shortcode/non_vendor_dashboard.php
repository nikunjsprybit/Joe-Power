...
if ($user && in_array('administrator', $user->roles)) {
    ?>
    <div class="vendor_apply non_vendor_message text-center">
        <p>
            <?php _e('You have logged in as Administrator. Please log out and then login as a Vender to view this page.', $WCMp->text_domain); ?>
        </p>
    </div>
    <?php
}
